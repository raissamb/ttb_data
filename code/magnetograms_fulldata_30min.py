...
ax.set(xlabel = "Time", ylabel = "nT", 
       title= "H in 1964-09-13 (all year data)")
#ax.set_ylim(min(y) - ymin, max(y) + ymax)
plt.xticks(rotation=90) 
ax.legend()
plt.tight_layout()
plt.show()
fig.savefig("../output/early_result_data_extraction/fulldata_prelim_result_30min_13_09_1964.png", 
