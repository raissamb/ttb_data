...
hfigname = f"../output/plot_baselines_scale_values/Full_{year}_H_fit_baseline.png"
ut.plot_fit(hx, hy, 1, "H", "Baseline", "nT", hfigname, 25, 25, "Full data")


# Fit Z
zaux = dfs_baselines[2]
zx = zaux["Decimal_year"]
zy = zaux["Baseline_means_nT"]
zcoeff = np.polyfit(zx, zy, 1)
print("Z fit: ", np.poly1d(zcoeff))
zfigname = f"../output/plot_baselines_scale_values/Full_{year}_Z_fit_baseline.png"
ut.plot_fit(zx, zy, 1,"Z", "Baseline", "nT", zfigname, 75, 50,"Full data" )
...
dfigname = f"../output/plot_baselines_scale_values/Full_{year}_D_fit_baseline.png"
ut.plot_fit(dx, dy, 1,"D", "Baseline", "dd", dfigname, 0.02, 0.02, "Full data")
...
hfigname = f"../output/plot_baselines_scale_values/Full_{year}_H_fit_scale_values.png"
ut.plot_fit(hx2, hy2, 1, "H", "Scale Value", "min/mm", hfigname, 25, 25, "Full data")
...
zfigname = f"../output/plot_baselines_scale_values/Full_{year}_Z_fit_scale_values.png"
ut.plot_fit(zx2, zy2, 1, "Z", "Scale Value", "nT/mm", zfigname, 1, 1, "Full data")
...
dfigname = f"../output/plot_baselines_scale_values/Full_{year}_D_fit_scale_values.png"
ut.plot_fit(dx2, dy2, 1, "D", "Scale Value", "min/mm", dfigname, 1, 1, "Full data")
